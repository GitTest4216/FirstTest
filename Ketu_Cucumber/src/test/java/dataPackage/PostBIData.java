...
//	protected WebElement CopayInsuranceValue;
	...
	@FindBy(how = How.XPATH, using = "//*[contains(@id,'activtyRadioComplete')]")
	...
	public void cocWorkFlowClick() throws InterruptedException {
		...
		ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Clicked on CoC Workflow");
			...
			//ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occurred while Clicking on CoC Workflow");
		}
	}
	...
	public void selectInsurance(WebElement insurance, WebElement searchElement, String insuranceName) throws InterruptedException {
		Thread.sleep(1000);
		insurance.click();
