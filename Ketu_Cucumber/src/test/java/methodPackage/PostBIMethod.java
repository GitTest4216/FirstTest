...
//	String PostBIPermission = DpModulePermission.getRow(16).getCell(2).getStringCellValue();
	...
	public void openPostBI() throws IOException {
		// PayorData p1 = PageFactory.initElements(driver, PayorData.class);
		...
		try {
			 ...
			 * CaseManagementTab.getLocation().y + ")"); CaseManagementTab.click(); if
			 * (CaseID.isDisplayed()) {
			 * 
			 * ((JavascriptExecutor) driver).executeScript("window.scrollTo(0," +
			 * CaseID.getLocation().y + ")");
			 * 
			 * CaseID.click(); }
			 */
	...
	public void VerifyPostBIWithValidData() throws IOException {
		...
		try {
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Entered Rx Dispensed Date - " + "<b>" + date1 + "</b>");
			} catch (Exception e) {
				ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Rx Dispensed Date");
				ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
						MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
			}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Selected Primary Insurance - " + "<b>" + PIName + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Selecting Primary Insurance");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Final Claim Adjudicated Successfully? - " + "<b>" + "Yes" + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Clicking on Final Claim Adjudicated Successfully? radio");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Primary Insurance Billed Amount");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Entered Primary Insurance Paid Amount - " + "<b>" + PrimaryPaid + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Primary Insurance Billed Amount");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		...
		try {	selectInsurance(SecondaryInsurance, SecondarySearch, SecInsName);
			System.out.println("Selected Secondary insurance");
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Selected Secondary Insurance - " + "<b>" + SecInsName + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Selecting Secondary Insurance");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}

			// Select on Yes radio button on Secondary
			try{clickOnRadioButton(SecondaryInsYesbtn);
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Final Claim Adjudicated Successfully? - " + "<b>" + "Yes" + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Clicking on Final Claim Adjudicated Successfully? radio button");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Secondary Insurance Paid Amount");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Entered Co-Pay Card Paid Amount - " + "<b>" + CopayPaid + "</b>");
			} catch (Exception e) {
				ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Co-Pay Card Paid Amount");
				ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
						MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
			}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Selecting Foundation Support");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			// ===========Click on Yes Radio==================
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Entered Foundation Support Paid Amount - " + "<b>" + FoundationPaid + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Foundation Support Paid Amount");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Entered Patient Co-Pay Amount - " + "<b>" + PatientCopayAmount + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Patient Co-Pay Amount");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			// ============DrugAmount
			...
			ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, "Entered Drug Acquisition Amount - " + "<b>" + DrugAcquisitionAmount + "</b>");
		} catch (Exception e) {
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Entering Drug Acquisition Amount");
			ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
					MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
		}
			...
			Thread.sleep(1000);
			//ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, CaptureScreen(driver), "POST BI added Successfully");
	...
	public void verifyPostBIwithoutData() throws InterruptedException, IOException {
		...
		e.printStackTrace();
		ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL, "Error occured while Clicking on Complete Button");
		ExtentCucumberAdapter.getCurrentStep().log(Status.FAIL,
				MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build());
	}
		Thread.sleep(2000);
		...
		ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, MediaEntityBuilder.createScreenCaptureFromPath(CaptureScreen(driver)).build() + "Saved PostBi without Adding any data");
		//ExtentCucumberAdapter.getCurrentStep().log(Status.PASS, test.addScreenCapture(CaptureScreen(driver)), "Saved PostBi without Adding any data");
