...
public class AddCaseMethods extends AddCaseData {
	...
	public void addNewCase() throws IOException {
		...
		test = report.createTest("Verfiy the click on Add Case button in Case management");
	...
	public void caseManagementTabOnlyPharmacyStoreSelected() throws InterruptedException, IOException {
		test = report.createTest("Verify Add Case with only Pharmacy Store");
		if (CaseManagementTabpermission.equalsIgnoreCase("YES")) {
			try {
	...
	public void caseManagementTabOnlyStoreandTCSelected() throws InterruptedException, IOException {
		test = report
				.createTest("Verify click on create case button after select Pharmacy Store and Therapeutic Program ");
		if (CaseManagementTabpermission.equalsIgnoreCase("YES")) {
	...
	public void caseManagementTabOnlyServicesSelected() throws InterruptedException, IOException {
		test = report.createTest(
				"Verify click on create case button after select Pharmacy Store,Therapeutic Program and Select Services ");
		if (CaseManagementTabpermission.equalsIgnoreCase("YES")) {
			selectServiceValue();
			createCaseClick();
			Thread.sleep(1000);
...
//	}
	...
	public void caseManagementAllValiddata() throws InterruptedException, IOException {
		test = report.createTest("Verify click on create case with All Valid Data");
		caseManagementTabClick();
		Thread.sleep(2000);
		addCaseClick();
		Thread.sleep(2000);
