...
public class AddConsentData  extends Base{
	...
	protected WebElement assignedroleSearch;
	
	@FindBy(how = How.XPATH, using = "/html/body/span/span/span[2]")
	protected String assignedroleSearchTable;
	
	
	@FindBy(how = How.XPATH, using = "//*[@id=\"select2-consentTo-container\"]")
	protected WebElement assigneduser;
	
	@FindBy(how = How.XPATH, using = "/html/body/span/span/span[1]/input")
	protected WebElement assignUserSearch;
	
	@FindBy(how = How.XPATH, using = "//*[@id=\"select2-consentTo-results\"]")
	protected WebElement assigneUserSearchTable;
