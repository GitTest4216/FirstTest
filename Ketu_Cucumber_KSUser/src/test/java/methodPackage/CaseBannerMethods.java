...
//	private String PhRxIdDropdown = DpModulePermission.getRow(19).getCell(1).getStringCellValue();
	...
	private String assignedrolevalue = DpCaseBanner.getRow(2).getCell(4).getStringCellValue();
	private String assigneduservalue = DpCaseBanner.getRow(2).getCell(5).getStringCellValue();
...
//		
		try {
			...
			Thread.sleep(2000);
			AssignUser(assignedrolevalue, assigneduservalue);
			Thread.sleep(1000);
			saveButtonClick();
			capture_Screenshot();
		} catch (Exception e) {
